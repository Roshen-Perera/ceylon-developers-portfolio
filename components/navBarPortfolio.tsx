...
const NavBarPortfolio = () => {
  return (
    <div className="flex items-center justify-center w-full p-8 relative z-30">
      <div>
        <div className="flex flex-row fixed justify-between w-[1140px] h-16 items-center rounded-full bg-[var(--navbar-background)] border shadow-lg left-1/2 transform -translate-x-1/2">
