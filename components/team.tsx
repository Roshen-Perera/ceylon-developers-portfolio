...
const Team = () => {
  return (
    <div className="flex flex-col items-center justify-center mt-20">
      ...
      <div className="bg-white rounded-2xl overflow-hidden max-w-xs shadow-lg">
        {/* Image */}
        ...
        <div className="bg-[#F7F7F7] p-3">
          <div className="flex items-start justify-between p-5 bg-white rounded-2xl">
            ...
            <div className="flex gap-2">
              <button className="w-7 h-7 flex items-center justify-center border border-cyan-400 rounded hover:bg-cyan-50 transition-colors">
                <svg
