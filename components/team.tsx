...
const Team = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-20">
      ...
      <button className="bg-[#17CDCA] mt-15 text-black font-medium rounded-md hover:bg-cyan-500 transition-colors px-6 py-2 h-fit flex justify-center items-center gap-3">
