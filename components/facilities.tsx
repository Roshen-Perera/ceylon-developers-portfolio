        ...
        <div className="w-full max-w-7xl">
          <div className="flex flex-col gap-6 sm:gap-8 lg:gap-10">
            ...
            <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-10">
              ...
              <div className="w-full lg:flex-1 h-auto min-h-[280px] sm:min-h-80 md:h-[329px] lg:h-[329px] xl:h-[350px] 2xl:h-[375px] bg-[#6F6F6F1A] border rounded-3xl sm:rounded-4xl overflow-hidden">
                <div className="flex flex-col sm:flex-row p-4 sm:p-6 lg:p-8">
                  <div className="mb-4 sm:mb-0 sm:mr-4 lg:mr-6 shrink-0">
                    <AnalyticsVector />
                  </div>
